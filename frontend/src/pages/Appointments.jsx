...
const Appointments = () => {
  ...
  return (
    <div class="flex flex-col sm:flex-row gap-8 font-[sans-serif] max-w-5xl max-sm:max-w-sm mx-auto p-4">
      <div class="">
        <img src={doctorInfo.image} class="bg-primary rounded-lg sm:max-w-72" />
      </div>

      <div>
        <div className="flex flex-1 flex-col gap-2">
          <h3 class=" flex gap-1 text-xl font-extrabold text-gray-800">
            {doctorInfo.name}{" "}
          ...
          <div>
            ...
            <p class="text-sm text-gray-800">{doctorInfo.about}</p>
          </div>
        </div>

        <div class="mt-8 text-left">
          <h4 class="text-base font-bold">
            Appointment Fee: {currencySymbol}{doctorInfo.fees}
          </h4>
        </div>
