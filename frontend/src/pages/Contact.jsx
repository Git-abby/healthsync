  ...
  return (
    ...
    <div className="grid sm:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-4">  Explore virtual care for your organization today. Get started by filling out the form below.</p>
          ...
          <ul className="mt-4">
            <li className="flex items-center">
              <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#5f6fffba'
              ...
              <a href="" className="text-primary-light text-sm ml-4">
                <small className="block">Mail</small>
                <strong>info@healthsync.com</strong>
              </a>
            </li>
          </ul>
        </div>
      ...
      <form className="ml-auo space-y-4">
        ...
        <button type='button'
          className="text-white bg-primary-light hover:bg-primary rounded-md text-sm px-4 py-2.5 w-full !mt-6">Send</button>
      </form>
    </div>
  </div>
  )
